...
//                singlePageActivity.showRemoveBtn();
//            }
//        }
        addView(v, views.size(), pager,circleIndicator);
        notifyDataSetChanged();
    }
    ...
    // The app should call this to add pages; not used by ViewPager.
    public void addView(SinglePage v, int position, ViewPager pager,CircleIndicator circleIndicator) {
...
//    }
    ...
    // Retuns position of removed view.
    // The app should call this to remove pages; not used by ViewPager.
    public void removeView(ViewPager pager, int position, CircleIndicator circleIndicator) {
        ...
        if ((position < 0) || (position >= views.size()) || (views.size() <= 1)) {
            return;
        } else {
            if (views.size() == 2) {
                singlePageActivity.setOnePageOnly(true);
                if (singlePageActivity.isViewing()) {
                    singlePageActivity.hideRemoveBtn();
                }
            }
    ...
    public void setPrimaryItem(ViewGroup container, int position, Object object) {
        if (mCurrentPage != object) {
            mCurrentPage = ((SinglePage) object);
